    ...
    <div className="p-2 border-b-2 border-b-muted ">
      <div className="flex justify-between items-center">
        <div className="flex flex-col items-start gap-0.5 text-lg">
          <p className="font-semibold">Sender:{message?.sender?.portfolio}</p>
          <p className="font-semibold">
            Receiver:{message?.receiver?.portfolio}
          </p>
        </div>
        <div className="py-2 px-2.5 rounded-full bg-muted-foreground/10 text-muted-foreground text-lg">
          {message?.status}
        </div>
      </div>
